...
# GAS service publication wrapper for ExploratorySpatialDataAnalysisAgent.

from gas_server.agents.exploratory_spatial_data_analysis_agent import ExploratorySpatialDataAnalysisAgent


REGISTRATION = register_geo_agent(ExploratorySpatialDataAnalysisAgent, __name__)
