...
from gas_server.agents.spatiotemporal_conflict_event_agent import SpatiotemporalConflictEventAgent


REGISTRATION = register_geo_agent(SpatiotemporalConflictEventAgent, __name__)
