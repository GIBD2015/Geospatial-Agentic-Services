...
# This file is the GAS service publication wrapper for GeospatialDataInspectionAgent.
#
...
REGISTRATION = register_geo_agent(GeospatialDataInspectionAgent, __name__)
