...
# This file is the GAS service publication wrapper for GeospatialDataRetrievalAgent.
#
...
REGISTRATION = register_geo_agent(GeospatialDataRetrievalAgent, __name__)
