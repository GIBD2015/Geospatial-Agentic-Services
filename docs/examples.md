...
The example notebooks demonstrate how to consume GAS services with raw HTTP
requests, the Python client SDK, streamed execution, distributed service
chains, and multi-agent workflows.

The notebooks live in the GitHub repository:

- [Example notebook folder](https://github.com/GIBD2015/geospatial-agentic-services/tree/main/examples_for_using_gas_services)
